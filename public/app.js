const themes = {
  sunset: {
    ...
    accent: "#2f6b3c",
    accentStrong: "#1f4a29",
    accentSoft: "rgba(47, 107, 60, 0.16)",
    accentOutline: "rgba(47, 107, 60, 0.28)",
    accentFocus: "rgba(47, 107, 60, 0.42)",
    accentTransparent: "rgba(47, 107, 60, 0.18)",
    ambientA: "rgba(47, 107, 60, 0.18)",
    ambientB: "rgba(31, 74, 41, 0.1)",
    ambientC: "rgba(47, 107, 60, 0.08)",
    success: "#2b8a67",
    swatch: ["#d7ead8", "#2f6b3c", "#8fb89a"]
  },
  harbor: {
    name: "Harbor Night",
    bg: "#ffffff",
  ...
  return `
    <main class="setup-wizard">
      <section class="hero-card wizard-shell">
        ...
        <h2 class="hero-title wizard-hero-title">Lets build your bingo board!</h2>
